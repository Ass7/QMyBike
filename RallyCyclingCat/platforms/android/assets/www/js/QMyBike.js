										...
										promisedCPWriter
												.then(
														...
														function(error) {
															...
															// creation.
															console
																	.log('error in CP writer creation.');
															console
																	.error(error);
															alert(error);
														});
										...
										promisedCPReader
												.then(
														...
														function(error) {
															...
															// creation.
															console
																	.log('error in CP reader creation.');
															console
																	.error(error);
															alert(error);
														});
										...
										promisedMFWriter
												.then(
														function(writer) {
															...
															// created.
															console
																	.log('MF writer is created.');
														},
														function(error) {
															// error in writer
															// creation.
															console
																	.log('error in MF writer creation.');
														});
										...
										promisedMFReader
												.then(
														function(reader) {
															...
															// created.
															console
																	.log('MF reader is created.');
														},
														function(error) {
															// error in reader
															// creation.
															console
																	.log('error in MF reader creation.');
														});
